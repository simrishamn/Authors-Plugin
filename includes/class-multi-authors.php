...
class Multi_Authors {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Multi_Authors_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Multi_Authors_Loader. Orchestrates the hooks of the plugin.
	 * - Multi_Authors_i18n. Defines internationalization functionality.
	 * - Multi_Authors_Admin. Defines all hooks for the admin area.
	 * - Multi_Authors_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Multi_Authors_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Multi_Authors_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Multi_Authors_Loader    Orchestrates the hooks of the plugin.
	 */
